...
| Local patches | 8 — CMake subproject embedding; cellMic WITHOUT_OPENAL; fmt noreturn-dtor (clang 18+); Android Vulkan surface fix; VKOverlays include; JITLLVM pre-21 LLVM compat; arm64 -march baseline override; SQRDMLAH QRDMX guard. All upstream candidates (see [`patches/series`](../patches/series)) |
