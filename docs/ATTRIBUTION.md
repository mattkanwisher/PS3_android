...
| Local patches | 6 — CMake subproject embedding; cellMic WITHOUT_OPENAL; fmt noreturn-dtor (clang 18+); Android Vulkan surface fix; VKOverlays include; JITLLVM pre-21 LLVM compat. All upstream candidates (see [`patches/series`](../patches/series)) |
