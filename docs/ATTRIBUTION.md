...
| Local patches | 7 — CMake subproject embedding; cellMic WITHOUT_OPENAL; fmt noreturn-dtor (clang 18+); Android Vulkan surface fix; VKOverlays include; JITLLVM pre-21 LLVM compat; arm64 -march baseline override. All upstream candidates (see [`patches/series`](../patches/series)) |
