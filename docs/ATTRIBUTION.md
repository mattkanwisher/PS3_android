...
| Local patches | 3 — CMake subproject-embedding paths; cellMic WITHOUT_OPENAL; fmt noreturn-dtor for clang 18+. All upstream candidates (see [`patches/series`](../patches/series)) |
